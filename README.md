# 🔴 겸용 펌프 용량 계산서 — 옥내소화전 + 옥외소화전 · **Ver 5.0**

> **Developer MANMIN** | ㈜대성건축사사무소
> MANMIN WAP 디자인 통일 · 소방 계열 07.
...
```
옥내옥외겸용_{공사명}_{YYYYMMDD}[_n].jpg     페이지당 1588 × 2246px (scale 2)
```
...
| 기준 | 적용 | 계산 조항 |
|---|---|---|
| **NFPC / NFTC 102** 옥내소화전설비 | **제2025-25호 · 2026.3.1 시행** | 제4조 수원 · 제5조 `0.17MPa · 130ℓ/min` |
| **NFPC / NFTC 109** 옥외소화전설비 | **2025.12.31 공포 · 2026.3.1 시행** | 제4조 수원 `N × 7㎥` · 제5조 `0.25MPa · 350ℓ/min` |

> **개정 영향 없음.** 109의 **방수총 신설**은 배치 기준이라 계산식과 무관하다.
> 다만 공장·창고 특수가연물 **750배 이상**이면 방수총이 추가 의무이므로 별도 검토가 필요하다.
